...
$TCA['tx_edfu_domain_model_form'] = array(
	...
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, transliteration, translation, text_type, photos, literature',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, transliteration, translation, text_type, photos, literature,--div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access,starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
			...
			'config' => array(
				...
				'wizards' => array(
					...
					'add' => Array(
						...
						'icon' => 'add.gif',
						'params' => array(
							'table' => 'tx_edfu_domain_model_photo',
							'pid' => '###CURRENT_PID###',
							'setValue' => 'prepend'
							),
